...
export default function AboutSection() {
  return (
    <section id="about" className="section-full relative" style={{ backgroundColor: 'hsl(0, 0%, 98%)' }}>
      {/* Decorative dots */}
      ...
      <div className="max-w-6xl mx-auto px-8 grid md:grid-cols-2 gap-16 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-8" style={{ color: 'hsl(239, 84%, 67%)' }}>
            Design
          </h2>
